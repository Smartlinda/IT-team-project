...
public class GenericUser
{
   ...
   { // Not sure if this is the best way to make a method like this
      return selectedCategory;
   }

   public void calculateNumberOfWins()
   { // If this player is the winner of the round, add one to the number of
     // wins.
   ...
   { // add the given card to the bottom of the pile
      personalDeck.add(card);
   }

   public void removeTopCard(Card card)
   { // remove the card from the top of the pile
